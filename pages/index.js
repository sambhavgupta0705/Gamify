    ...
    <div>
      ...
      <div className="flex justify-between flex-wrap">
        ...
        <img
          ...
          <div class="px-6 py-4 text-center">
            ...
            <p class="text-gray-700 text-base">
            2048 is a single-player sliding tile puzzle video game to connect numbers.
            </p>
          </div>
          <div class="px-6 pt-4 pb-2">
            <div className="text-center">
      ...
      <div class="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4 text-center">
            ...
            <p class="text-gray-700 text-base">
              Guess the correct word in minimum number of tries.
            </p>
          </div>
          <div class="px-6 pt-4 pb-2">
            <div className="text-center">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4 text-center">
            ...
            <p class="text-gray-700 text-base">
              The hand game to try your luck,play it with computer.
            </p>
          </div>
          <div class="px-6 pt-4 pb-2">
            <div className="text-center">
        ...
        <div class="max-w-sm rounded overflow-hidden shadow-lg">
          ...
          <div class="px-6 py-4 text-center">
            ...
            <p class="text-gray-700 text-base">
            Test your basic knowledge on variety of fun and interesting topics.
            </p>
          </div>
          <div class="px-6 pt-4 pb-2">
            <div className="text-center">
